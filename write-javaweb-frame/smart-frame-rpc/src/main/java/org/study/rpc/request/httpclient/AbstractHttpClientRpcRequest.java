...
import org.study.rpc.request.AbstractRpcRequest;
...
public abstract class AbstractHttpClientRpcRequest extends AbstractRpcRequest {
    ...
    protected String doSpecifiedRequest(HttpUriRequest request) {
        ...
        if (statusCode == 200) {
            return getResponseResultAsString(httpResponse, request);
        }
    ...
    private String getResponseResultAsString(HttpResponse httpResponse, HttpUriRequest request) {
        try {
